...
export declare class GasFeeController extends BaseController<typeof name, GasFeeState> {
    ...
    fetchGasFeeEstimates(options?: FetchGasFeeEstimateOptions): Promise<GasFeeState | undefined>;
     ...
     */
    _fetchGasFeeEstimateData(options?: FetchGasFeeEstimateOptions): Promise<GasFeeState | undefined>;
    /**

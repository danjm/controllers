    ...
    fetchFromStaticTokenList() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const tokenAddress in contract_metadata_1.default) {
                const _a = contract_metadata_1.default[tokenAddress], { erc20, logo } = _a, token = __rest(_a, ["erc20", "logo"]);
                if (erc20) {
                    tokenList[tokenAddress] = Object.assign(Object.assign({}, token), { iconUrl: logo });
                }
            }
            this.update(() => {
                return {
